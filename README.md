...
### Important note about fork: this is the same 1.4.1 version + one new option:
* **groupClusterByCommonValue**: This field will be used to decide which markers can cluster with each other. Example: state, county, zipcode, etc.
